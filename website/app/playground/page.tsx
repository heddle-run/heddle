...
export const metadata: Metadata = {
  title: "Playground",
  description:
    "Write a Weave flow, wire tools and plugins, and run it in the browser against a live heddle engine. Or read the same use case in heddle, LangGraph, the OpenAI Agents SDK and Google ADK, side by side.",
