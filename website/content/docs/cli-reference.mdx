...
```bash
$ heddle doctor zoom-notetaker.heddle
...
starts; on a terminal it pauses there — fix the machine in another shell, press enter to
re-check — and anywhere else it fails with the same list. `heddle doctor` is how you ask
